...
const InvertedScrollArea = React.forwardRef<React.ElementRef<typeof ScrollAreaPrimitive.Root>, InvertedScrollAreaProps>(({ className, children, scrollRef, contentRef, ...props }, ref) => (
  <ScrollAreaPrimitive.Root ref={ref} className={cn("relative overflow-hidden", className)} {...props}>
    <ScrollAreaPrimitive.Viewport className="h-full w-full rounded-[inherit]" ref={scrollRef}>
      <ol ref={contentRef} className="max-h-full overflow-y-hidden">
        {children}
      </ol>
